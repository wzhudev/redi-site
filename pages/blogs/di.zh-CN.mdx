...
export class FindReplaceController extends RxDisposable {
    constructor(
		    ...
		    this._shortcutService = new ShortcutService(commandService, platformService, contextService, layoutService);
    }
}
```
...
<Callout>本小节的内容涉及 redi 的 API，请参考阅 [这里的文档](/docs/concepts)</Callout>
