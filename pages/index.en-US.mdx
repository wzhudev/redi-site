...
<p className="flex h-6">
  <img
    alt="stars"
    src="https://badgen.net/github/stars/hullis/redi"
  ...
  <img
    alt="license"
    src="https://badgen.net/github/license/hullis/redi"
    className="inline-block mr-2"
  />
</p>
...
<Callout>Write code that is less coupling, more convenient to modify and easier to maintain with help of dependency injection.</Callout>
...
[Demo TodoMVC](https://hullis.github.io/redi-todomvc/) | [Demo Repos](https://github.com/hullis/redi-todomvc)