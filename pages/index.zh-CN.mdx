...
<Callout>
  不了解依赖注入，或者没想好要不要使用依赖注入？请请阅读我们的[博客](/blog/di)以了解依赖注入想要解决的问题以及其优点。
</Callout>
...
[立即开始](/docs/introduction) | [Demo TodoMVC](https://wendellhu95.github.io/redi-todomvc/) | [Demo 仓库](https://github.com/wendellhu95/redi-todomvc) | [脚手架](https://github.com/wendellhu95/redi-starter)
