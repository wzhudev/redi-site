...
const INetworkInterceptor = createIdentifier<IHttpInterceptor>('network-interceptor')
...
console.log(injector.get(IHttpInterceptor) === injector.get(INetworkInterceptor)) // true
```
