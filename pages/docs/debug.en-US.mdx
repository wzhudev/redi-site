...
... or fix cycle dependency in your codebase. We recommend using [bnpm](https://www.npmjs.com/package/dpdm) to find cycle dependency in your codebase. You could traverse the dependency tree staring from the file that contains `XXX`, and break cycles those contains the file.
